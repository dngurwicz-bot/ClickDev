    ...
    return (
        <div className="flex flex-col h-full w-full bg-bg-main p-8" dir="rtl">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-3xl font-bold text-secondary">טבלת צוותים</h1>
                    <p className="text-gray-500 mt-1">רשימת הצוותים בארגון.</p>
                </div>
                <Button onClick={() => router.push('/dashboard/core/teams/new')} className="flex items-center gap-2 bg-primary hover:bg-primary-dark">
