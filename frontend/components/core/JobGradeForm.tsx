...
export function JobGradeForm({ initialData, onSuccess, onCancel }: JobGradeFormProps) {
    ...
    return (
        <div className="bg-[#f3f4f6] min-h-[350px] flex flex-col border border-gray-400 font-sans" dir="rtl">
            ...
            <form id="job-grade-form" onSubmit={handleSubmit(onSubmit, onError)} className="p-8 pt-10 space-y-12 flex-1 overflow-y-auto relative">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1 relative">
                                <input
                                    {...register('name')}
                                    className="w-full h-8 bg-[#E0F5F3] border border-[#00A896]/30 px-2 text-sm focus:border-[#00A896] outline-none shadow-sm"
                                />
