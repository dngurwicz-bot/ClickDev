...
export function PriorityRecordLayout({
    ...
    return (
        <div className="bg-bg-main min-h-full flex flex-col font-sans" dir="rtl">
            {/* Unified Header Bar */}
            <div className="h-14 bg-secondary border-b border-white/10 flex items-center px-4 justify-between shrink-0 shadow-sm z-10">
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-100 overflow-hidden">
                            ...
                            {id && (
                                <div className="flex items-center gap-2">
                                    <span className="text-gray-400 text-xs font-medium uppercase">מספר עובד:</span>
                                    <span className="font-mono bg-white/10 px-2 py-0.5 rounded text-white font-bold">{id}</span>
                                </div>
                            )}
                            ...
                            {subtitle && (
                                <div className="flex items-center gap-2">
                                    <span className="text-gray-400 text-xs font-medium uppercase">שם:</span>
                            ...
                            {status && (
                                <div className="flex items-center gap-2">
                                    <span className="text-gray-400 text-xs font-medium uppercase">סטטוס:</span>
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button onClick={onPrint} className="flex items-center gap-2 px-3 py-1.5 hover:bg-white/10 rounded transition-colors group" title="הדפס">
                        <Printer className="w-4 h-4 text-gray-300 group-hover:text-white" />
                        <span className="text-xs font-medium text-gray-300 group-hover:text-white hidden xl:block">הדפס</span>
                    </button>

                    <button className="flex items-center gap-2 px-3 py-1.5 hover:bg-white/10 rounded transition-colors group" title="נספחים">
                        <Paperclip className="w-4 h-4 text-gray-300 group-hover:text-white" />
                        <span className="text-xs font-medium text-gray-300 group-hover:text-white hidden xl:block">נספחים</span>
                    </button>
                    ...
                    <button onClick={onDelete} className="flex items-center gap-2 px-3 py-1.5 hover:bg-white/10 hover:bg-red-500/10 rounded transition-colors group" title="מחק">
                        <Trash2 className="w-4 h-4 text-gray-300 group-hover:text-red-400" />
                        <span className="text-xs font-medium text-gray-300 group-hover:text-red-400 hidden xl:block">מחק</span>
                    </button>
                </div>
            </div>
