-- Refine 'Set' (4) Logic: "Reset from this date"
-- 1. Delete ALL records where effective_from (or valid_from) >= New Date.
-- 2. Cap the Previous record (if exists) at New Date - 1.
-- 3. Insert New Record (Open Ended).
