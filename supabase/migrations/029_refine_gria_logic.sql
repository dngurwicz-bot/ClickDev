-- Refine Gria (3) logic: When deleting, extend previous record's validity.
-- If the deleted record was the last one, the previous record's end date should be cleared (become active).
-- If there was a gap, it should potentially extend to the next record.
...
BEGIN
    ...
    IF p_event_code = '100' THEN
        ...
        ELSIF p_operation_code = '3' THEN
            ...
            ELSE
                -- Close Validity of covering event (Standard Gria behavior for 'Closing')
